...
# autoencoder.encode_data(a_scaled_full, csv_path='train_test_data/full_x.csv')
...
print('Loading data...')
train_x = pd.read_csv('data/processed_data/train_test_data/train_x.csv', index_col=0)
train_y = pd.read_csv('data/processed_data/train_test_data/train_y.csv', index_col=0)
test_x = pd.read_csv('data/processed_data/train_test_data/test_x.csv', index_col=0)
test_y = pd.read_csv('data/processed_data/train_test_data/test_y.csv', index_col=0)
print(train_x.head())
